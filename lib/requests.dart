...
Future<MathFact> fetchFact(String number, String target) async {
  String url = '';
  if (target == 'trivia'){url = 'http://numbersapi.com/$number';}
  else if (target == 'date'){url = 'http://numbersapi.com/$number/date';}
  else if (target == 'math'){url = 'http://numbersapi.com/$number/math';}
